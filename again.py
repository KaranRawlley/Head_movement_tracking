...
but1 = Button(window, text='Withdraw', width=40,
              height=10, bg='#7cfc00', fg='black', bd=5)
...
while True:
 ...
 # Draw a rectangle around the faces
   ...
   # Converting the OpenCV rectangle coordinates to Dlib rectangle
        ...
        bl = sqrt(bottomleft[0, 0]*bottomleft[0, 0] +
                  bottomleft[0, 1]*bottomleft[0, 1])
        bottomright = (landmarks[RIGHT_LIP_POINTS]-landmarks[NOSE_POINTS])
        br = sqrt(bottomright[0, 0]*bottomright[0, 0] +
                  bottomright[0, 1]*bottomright[0, 1])
    ...
    but1 = Button(window, text='7', width=40, height=10,
                  bg='#7cfc00', fg='black', bd=5)
    but1.grid(row=1, column=1)
